...
e) Interfere with or disrupt our Services, including circumvent any rate limits or restrictions or bypass any protective measures or safety mitigations we put on our Services.

f) Use Content from the Services to develop competing products or services.
...
We reserve the right to terminate or restrict your account, or revoke your access to the Service, at any time if we suspect you have violated these TOS or any other Terms or Policies. You agree that we will not be liable to you or any third party for any denial of use, change of costs, or suspension or termination of your account.
...
We prioritize the safety and well-being of our users. We strongly advise all users to exercise caution and refrain from disclosing sensitive personal information while using the Services. This includes, but is not limited to, financial details, addresses, contact information, or passwords.
...
You may provide input within the Service ("Input") and receive output from the Services based on the Input ("Output"). Input and Output are collectively referred to as "Content."
...
i) You will comply with all applicable laws in your access and use of the Service, including the laws of your country or district.
...
We value the safety and integrity of all users. We have implemented content moderation measures to ensure compliance with our Terms and Policies. If our moderation systems detect any content that violates our terms, we reserve the right to review the flagged content and take appropriate action, including terminating the user's account.
...
You may choose a subscription plan, payable by credit card, or other payment methods available on the platform.
...
All details about your subscription, including start date, end date, and type of subscription plan, can be found in your account settings.

You may cancel your subscription at any time through your account settings. If you choose to cancel, your subscription will remain active until the end of the current billing period, and you will not be charged for the subsequent period.
...
b) **Usage Limits:** Any remaining usage allowances in your account may expire at the end of the billing period.

You may resubscribe at any time to regain access to premium features.

If a subscription is refunded, the subscription is deemed immediately cancelled. All access to premium features will be revoked at the time of refund processing.

If a client files a chargeback request, the subscription is immediately cancelled. All access to premium features will be revoked at the time the chargeback request is filed.
...
However, by purchasing a subscription and beginning to use the Service, you expressly consent to the immediate performance of the digital content and acknowledge that you lose your right of withdrawal once the digital content has been fully provided or the service has been actively used. You will be asked to confirm this waiver at checkout.

For full details, including the model withdrawal form required under Annex I(B) of Directive 2011/83/EU, please consult our [Right of Withdrawal](/right-of-withdrawal) page.

**11.5 Refund Policy**

You have 24 hours after your payment to request a refund. No refunds will be issued if your request is made more than 24 hours after payment.

We cannot issue refunds for technical issues on the user's side.

For purchases made in error, there is no guarantee of a refund unless the error occurred on our end.
...
We will collect and process your information in accordance with our [Privacy Policy](/privacy-policy).

**18. Digital Services Act (DSA) Compliance**
...
- [Copyright and Intellectual Property Policy (DMCA)](/dmca)
- [Content Removal and Complaints Policy](/content-removal-and-complaints)
