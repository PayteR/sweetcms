 ...
 *
 * Uses faker for realistic, varied data. Configurable counts at top.
...
async function seedBilling() {
  ...
  try {
    ...
    console.log('\n🎉 Billing demo data seeded successfully!\n');
    console.log('   Dashboard: http://localhost:3000/dashboard/settings/billing\n');
