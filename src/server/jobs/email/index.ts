...
export type TemplateName = 'welcome' | 'verify-email' | 'password-reset' | 'invitation' | 'payment-failed' | 'subscription-activated' | 'subscription-expiring' | 'subscription-expired' | 'subscription-canceled';

export const TEMPLATE_NAMES: TemplateName[] = ['welcome', 'verify-email', 'password-reset', 'invitation', 'payment-failed', 'subscription-activated', 'subscription-expiring', 'subscription-expired', 'subscription-canceled'];
