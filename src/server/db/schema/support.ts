...
// Re-export chat tables from core-chat module for schema discovery
export { saasSupportChatSessions, saasSupportChatMessages } from '@/core-chat/schema/support-chat';
